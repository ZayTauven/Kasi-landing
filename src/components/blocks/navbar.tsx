    ...
    dropdownItems: [
      {
        title: "Kasi Course",
        href: "/#course",
        description: "Déplacez-vous dans Dakar avec un Kasiman noté et suivi",
      },
      {
        title: "Kasi Livraison",
        href: "/#livraison",
        description: "Envoyez un colis, un repas, un document — en direct",
      },
      {
        title: "Kasi Entreprises",
        href: "/#entreprises",
        description: "Vos tournées et livraisons récurrentes, sans flotte à gérer",
      },
    ],
  },
  { label: "Kasiman", href: "/#kasiman" },
...
export const Navbar = () => {
  ...
  return (
    <section
      className={cn(
        "bg-background/70 absolute left-1/2 z-50 w-[min(90%,720px)] -translate-x-1/2 rounded-4xl border backdrop-blur-md transition-all duration-300",
        "top-5 lg:top-12",
      )}
    >
      <div className="flex items-center justify-between px-6 py-3">
        <Link href="/" className="flex shrink-0 items-center gap-2">
          <KasiWordmark className="text-primary text-[26px]" />
        </Link>
        ...
        <div className="flex items-center gap-2.5">
          ...
          <Button asChild className="max-lg:hidden">
            <Link href="/#telecharger">Obtenir l&apos;app</Link>
          </Button>
